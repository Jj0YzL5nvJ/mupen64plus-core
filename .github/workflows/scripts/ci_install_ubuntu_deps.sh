...
export BUILD_DEPS_I386="crossbuild-essential-i386 g++-13:i386 gcc-13:i386 libc6-i386"
...
for ARG in ${ENV_ARGS}; do
	case "${ARG}" in
		clang )
			...
			;;
		gcc )
			export CC_DEP="g++-13 gcc-13"
			;;
		multilib )
			export BUILD_DEPS_I386="g++-multilib g++-13-multilib gcc-13-multilib gcc-multilib libc6-dev-i386"
			;;
		x64 )
			export ARCH_DEP="x64"
			;;
